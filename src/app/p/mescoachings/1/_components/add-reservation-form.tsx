    ...
    <Card className="w-full max-w-md rounded-xl shadow-lg p-6">
      ...
      <CardContent className="space-y-6">
        <div className="space-y-2">
          ...
          <Input id="reservation-name" placeholder="Nom de la réservation" />
        </div>

        <div className="space-y-2">
          <Label htmlFor="reservation-description">Description</Label>
        ...
        <div className="space-y-2">
          <Label htmlFor="coaching-type">Type de coaching</Label>
          <Select>
            <SelectTrigger id="coaching-type">
              <SelectValue placeholder="Privé" />
            </SelectTrigger>
            <SelectContent>
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col items-center justify-center h-32 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 text-gray-500 cursor-pointer hover:bg-gray-100">
