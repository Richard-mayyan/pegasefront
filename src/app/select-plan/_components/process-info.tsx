...
export default function ProcessInfo() {
  return (
    <div className="bg-gradient-to-r from-teal-50 to-blue-50 border border-teal-200 rounded-lg p-6">
      <h3 className="text-lg font-semibold text-customBg-augmented mb-4 text-center">
        Comment ça marche ?
      </h3>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="text-center">
          <div className="w-12 h-12 bg-teal-100 rounded-full flex items-center justify-center mx-auto mb-3">
            <Users className="w-6 h-6 text-customBg" />
          </div>
          <h4 className="font-medium text-customBg-augmented mb-2">
            1. Choisissez votre plan
          </h4>
          <p className="text-sm text-customBg-hover">
        ...
        <div className="text-center">
          <div className="w-12 h-12 bg-teal-100 rounded-full flex items-center justify-center mx-auto mb-3">
            <CreditCard className="w-6 h-6 text-customBg" />
          </div>
          <h4 className="font-medium text-customBg-augmented mb-2">
        ...
        <div className="text-center">
          <div className="w-12 h-12 bg-teal-100 rounded-full flex items-center justify-center mx-auto mb-3">
            <Zap className="w-6 h-6 text-customBg" />
          </div>
          <h4 className="font-medium text-customBg-augmented mb-2">
      ...
      <div className="mt-6 p-4 bg-white rounded-lg border border-teal-200">
        <div className="flex items-center gap-2 text-customBg-hover">
          <CheckCircle className="w-5 h-5" />
          <span className="font-medium">Sécurisé et sans engagement</span>
        </div>
        <p className="text-sm text-customBg mt-2">
